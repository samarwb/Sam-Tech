...
<div class="one-page">
	<div class="one-page-inner one-default">
		<div class="container content">
			<div class="row">
				...
				<div class="col-md-6">
					<img src="<?php echo base_url(); ?>assets/img/main/img12.jpg" class="img-responsive margin-bottom-10" alt="">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="one-page-inner one-blue">
		<div class="container content">
			<div class="row">
				<div class="col-md-6">
					<img src="<?php echo base_url(); ?>assets/img/main/img3.jpg" class="margin-bottom-10 img-responsive" alt="">
				</div>
				<div class="col-md-6">
	...
	<div class="one-page-inner one-default">
		<div class="container content">
			<div class="row margin-bottom-60">
				...
				<div class="col-md-6">
					<img src="<?php echo base_url(); ?>assets/img/main/img18.jpg" class="img-responsive" alt="">
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					<img src="<?php echo base_url(); ?>assets/img/main/img1.jpg" class="img-responsive" alt="">
				</div>
				<div class="col-md-6">
					<h2>Excepturi sint occaecati cupiditate</h2>
					<p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut non libero consectetur adipiscing elit magna. Sed et quam lacus..</p>
					<p>Fusce adipiscin condimentum eleifend enim a feugiat. Pellentesque viverra vehicula sem lorem ipsum dolor sit ametut volutpat, consectetur adipiscing elit. Ut non libero magna. Sed et quam lacus. Fusce condimentum ipsum dolor sit amet enim a feugiat distinctio lorem ipsum dolor sit amet condimentum.</p>
	...
	<div class="one-page-inner one-red">
		<div class="container content">
			<div class="row">
				...
				<div class="col-md-6">
					<img src="<?php echo base_url(); ?>assets/img/main/img21.jpg" class="img-responsive margin-bottom-10" alt="">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="one-page-inner one-default">
		<div class="container content">
			<div class="row">
				<div class="col-md-6">
					<img src="<?php echo base_url(); ?>assets/img/main/img6.jpg" class="img-responsive margin-bottom-10" alt="">
				</div>
				<div class="col-md-6">
					...
					<div class="row margin-bottom-10">
						<div class="col-md-3">
							<a href="<?php echo base_url(); ?>assets/img/main/img12.jpg" title="Project #1" data-rel="gallery" class="fancybox">
								<img class="img-responsive" src="<?php echo base_url(); ?>assets/img/main/img12.jpg" alt="">
							</a>
						</div>
						<div class="col-md-3">
							<a href="<?php echo base_url(); ?>assets/img/main/img13.jpg" title="Project #2" data-rel="gallery" class="fancybox">
								<img class="img-responsive" src="assets/img/main/img13.jpg" alt="">
							</a>
						</div>
						<div class="col-md-3">
							<a href="<?php echo base_url(); ?>assets/img/main/img15.jpg" title="Project #3" data-rel="gallery" class="fancybox">
								<img class="img-responsive" src="<?php echo base_url(); ?>assets/img/main/img15.jpg" alt="">
							</a>
						</div>
						<div class="col-md-3">
							<a href="<?php echo base_url(); ?>assets/img/main/img16.jpg" title="Project #4" data-rel="gallery" class="fancybox">
			...
			<div class="row content-boxes-v2">
				<div class="col-md-4 md-margin-bottom-30">
					<h3 class="heading-sm">
						...
						<span>Fusce condimentum</span>
					</h3>
					<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's, fusce condimentum eleifend enim a feugiat. Pellentesque viverra vehicula sem ut volutpat. </p>
				</div>
				<div class="col-md-4 md-margin-bottom-30">
					<h3 class="heading-sm">
