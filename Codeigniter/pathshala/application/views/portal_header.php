<html>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/sky-forms-pro/skyforms/custom/custom-sky-forms.css">
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/revolution-slider/rs-plugin/css/settings.css" type="text/css" media="screen">
        <!--[if lt IE 9]><link rel="stylesheet" href="assets/plugins/revolution-slider/rs-plugin/css/settings-ie8.css" type="text/css" media="screen"><![endif]-->
        <!-- CSS Page Style -->
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/pages/page_search.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/pages/page_job.css">
        <!-- CSS Theme -->
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/owl-carousel/owl-carousel/owl.carousel.js"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/revolution-slider/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/revolution-slider/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
        <!-- JS Customization -->
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/plugins/revolution-slider.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/app.js"></script>
        <!-- CSS Pages Style -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/pages/page_one.css">
            ...
            <div class="header">
                <div class="container">
                    ...
                    <a class="logo" href="index.html">
                        <!--					<img src="assets/img/my-pathshala.png" alt="Logo">-->
                        My Pathshala
                    </a>
                    <!-- End Logo -->
                    ...
                    <div class="topbar">
                        <ul class="loginbar pull-right">
                            ...
                            <li><a href="<?php print site_url('portal/portallogin'); ?>">Login</a></li>
                            <li class="topbar-devider"></li>
                            <li><a href="<?php print site_url('portal/portalreg'); ?>">Register</a></li>
                        </ul>
                    </div>
                    <!-- End Topbar -->
